...
// Filtration values are kept on the power-distance scale: the (weighted)
// alpha value of a simplex is the squared radius of its smallest orthogonal
// ball, i.e. the sublevel value of f_i(x) = ||x - p_i||^2 - w_i. Values can
// be negative for weighted points (vertex value is -w_i, set in core.py).
